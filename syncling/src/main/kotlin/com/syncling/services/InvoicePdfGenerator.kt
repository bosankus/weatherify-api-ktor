...
/**
 * Renders an InvoiceRecord into a branded PDF that matches Syncling's dark/emerald
...
object InvoicePdfGenerator {
    ...
    // ─── Brand palette (sourced from Syncling checkout + tailwind theme) ─────
    ...
    private val EMERALD = DeviceRgb(0, 229, 160)           // #8B7EFF — primary accent
    private val EMERALD_DEEP = DeviceRgb(0, 168, 122)      // #5535DD — gradient end
    ...
    /**
     * The Syncling mark: a rounded emerald square with two crossing lines, mirroring
     * the checkout / favicon SVG. iText doesn't do real gradients in kernel without
     * shading patterns, so we approximate the #A890FF → #5535DD feel by painting two
