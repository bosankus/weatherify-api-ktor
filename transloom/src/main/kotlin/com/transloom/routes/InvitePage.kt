...
internal fun HTML.invitePage() {
    head {
        title { +"Transloom — You've been invited" }
...
.inv-btn:hover{background:#00c98d;transform:translateY(-1px);box-shadow:0 8px 24px -8px rgba(0,229,160,.45)}
...
(function(){
  ...
  window.tlToken = function(){ return localStorage.getItem('transloom_token'); };
