...
import com.androidplay.weatherify.util.ValidationUtils

/**
 * Implementation of UserRepository that uses MongoDB for data storage.
 */
class UserRepositoryImpl(private val databaseModule: WeatherifyDb) : UserRepository {
    ...
    override suspend fun findUserByEmail(email: String): Result<User?> {
        ...
        return try {
            val query = databaseModule.createFilter("email", email)
            val docCollection =
