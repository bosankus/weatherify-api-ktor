...
import com.androidplay.weatherify.domain.MonthlyRefundData
import com.androidplay.weatherify.domain.Refund
import com.androidplay.weatherify.domain.RefundSpeed
import com.androidplay.weatherify.domain.RefundStatus
 ...
 */
class RefundRepositoryImpl(private val databaseModule: WeatherifyDb) : RefundRepository {
    ...
    override suspend fun getTotalRefundedAmount(): Result<Double> {
        ...
        return try {
            ...
            val totalAmount = (result?.get("totalAmount") as? Number)?.toDouble() ?: 0.0
    ...
    override suspend fun getTotalRefundedForPayment(paymentId: String): Result<Int> {
        ...
        return try {
            ...
            val totalAmount = (result?.get("totalAmount") as? Number)?.toInt() ?: 0
