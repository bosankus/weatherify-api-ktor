...
import com.androidplay.weatherify.domain.ServiceHistory
 ...
 */
class ServiceCatalogRepositoryImpl(private val databaseModule: WeatherifyDb) : ServiceCatalogRepository {
